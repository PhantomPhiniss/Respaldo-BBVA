...
# Objetivo            : Transmite el archivo :TX_MX_ARCH_INV_CANDIDATOS_AAAAMMDD       #
...
NOM_ARCH=${TX_MX_ARCH_INV_CANDIDATOS_AAAAMMDD}
...
if [ -s ${PATH_ORIGEN}/${NOM_ARCH} ]
   then
      ...
      NOM_ARCH_TRANSM="TX_MX_ARCH_INV_CANDIDATOS_AAAAMMDD.sh"
