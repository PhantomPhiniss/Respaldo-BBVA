...
# Objetivo            : Transmite el archivo : TX_MX_ARCH_RES_PRODUCTOS_AAAAMMDD       #
...
NOM_ARCH=${TX_MX_ARCH_RES_PRODUCTOS_AAAAMMDD}
...
if [ -s ${PATH_ORIGEN}/${NOM_ARCH} ]
   then
      ...
      NOM_ARCH_TRANSM="TX_MX_ARCH_RES_PRODUCTOS_AAAAMMDD.sh"
