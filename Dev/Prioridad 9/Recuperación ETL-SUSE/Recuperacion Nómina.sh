...
# Autor               : Diego Rodrigo Fernández Zamroa                                 #
# Objetivo            : Recupera el archivo : RX_MX_ARCH_RES_NOMINA_AAAAMMDD           #
...
#### Nombre del archivo
NOM_ARCH=${RX_MX_ARCH_RES_NOMINA_AAAAMMDD}
NOM_ARCH_SHELL="RX_MX_ARCH_RES_NOMINA_AAAAMMDD.sh"  
