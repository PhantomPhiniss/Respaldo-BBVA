...
# Objetivo            : Transmite el archivo : TX_MX_ARCH_INV_AUTOAGENCIAS_AAAAMMDD    #
...
NOM_ARCH=${TX_MX_ARCH_INV_AUTOAGENCIAS_AAAAMMDD}

# Se determina ruta ORIGEN y SERVIDOR   ########

ORIGEN=54.207.230.132
...
if [ -s ${PATH_ORIGEN}/${NOM_ARCH} ]
   then
      ...
      NOM_ARCH_TRANSM="TX_MX_ARCH_INV_AUTOAGENCIAS_AAAAMMDD.sh"
