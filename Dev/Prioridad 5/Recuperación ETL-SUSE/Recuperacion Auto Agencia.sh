...
# Objetivo            : Recupera el archivo : RX_ARCH_RES_AUTOAGENCIAS_AAAAMMDD        #
...
NOM_ARCH=${ARCH_RES_AUTOAGENCIAS_AAAAMM
DD}
NOM_ARCH_SHELL="RX_ARCH_RES_AUTOAGENCIAS_AAAAMMDD.sh"  
