...
# Objetivo            : Recupera el archivo : RX_MX_ARCH_RES_AUTOAGENCIAS_AAAAMMDD     #
...
NOM_ARCH=${RX_MX_ARCH_RES_AUTOAGENCIAS_AAAAMMDD}
NOM_ARCH_SHELL="RX_MX_ARCH_RES_AUTOAGENCIAS_AAAAMMDD.sh"  
