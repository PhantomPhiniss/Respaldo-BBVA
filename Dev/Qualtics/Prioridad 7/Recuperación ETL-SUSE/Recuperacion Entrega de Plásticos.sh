...
# Objetivo            : Recupera el archivo : RX_MX_ARCH_RES_PLASTICOS_AAAAMMDD        #
# Periodicidad        : Diario                                                         #
#######################################################################################
...
#### Nombre del archivo
NOM_ARCH=${RX_MX_ARCH_RES_PLASTICOS_AAAAMMDD}
NOM_ARCH_SHELL="RX_MX_ARCH_RES_PLASTICOS_AAAAMMDD.sh"  
