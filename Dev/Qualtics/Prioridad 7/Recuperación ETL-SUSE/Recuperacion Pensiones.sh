...
# Objetivo            : Recupera el archivo : RX_MX_ARCH_RES_PENSIONES_AAAAMMDD        #
...
#### Nombre del archivo
NOM_ARCH=${RX_MX_ARCH_RES_PENSIONES_AAAAMMDD}
NOM_ARCH_SHELL="RX_MX_ARCH_RES_PENSIONES_AAAAMMDD.sh"  
