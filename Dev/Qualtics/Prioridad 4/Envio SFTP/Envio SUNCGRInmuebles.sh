...
# Objetivo            : Transmite el archivo : TX_MX_ARCH_INV_SUNCGRINM_AAAAMMDD       #
# Periodicidad        : Diaria                                                         #
# Creacion            :                                                                #
...
NOM_ARCH=${TX_MX_ARCH_INV_SUNCGRINM_AAAAMMDD}
...
DESTINO=150.100.230.28				                  ###  IP Equipo destino
...
if [ -s ${PATH_ORIGEN}/${NOM_ARCH} ]
   then
      ...
      NOM_ARCH_TRANSM="TX_MX_ARCH_INV_SUNCGRINM_AAAAMMDD.sh"
