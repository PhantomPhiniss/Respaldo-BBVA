...
# Autor               : Diego Rodrigo Fernanadez Zamora                                #
# Objetivo            : Transmite el archivo : TX_MX_ARCH_INV_INMADJ_AAAAMMDD          #
# Periodicidad        : Diaria                                                         #
# Creacion            :                                                                #
...
NOM_ARCH=${TX_MX_ARCH_INV_INMADJ_AAAAMMDD}

# Se determina ruta ORIGEN y SERVIDOR   ########
ORIGEN=CDLVMPRODSWCL
PATH_ORIGEN=/filesystem/sftptrans/Qualtrics               

# Se Determina ruta DESTINO y SERVIDOR  ########
DESTINO=150.100.230.28
PATH_DESTINO=/filesystem/sftptrans/Qualtrics              
...
if [ -s ${PATH_ORIGEN}/${NOM_ARCH} ]
   then
      ...
      NOM_ARCH_TRANSM="TX_MX_ARCH_INV_INMADJ_AAAAMMDD.sh"
